package com.example.deepseek.component;
...
public class SendEmailComponent {
    ...
    public static String myEmailAccount = "1165288531@qq.com";
    public static String myEmailPassword = "wchrwhclsohiieae";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "3081323165@qq.com";
